...
<head>
  ...
  @import url('https://fonts.googleapis.com/css2?family=Playwrite+DE+SAS:wght@100..400&family=Playwrite+ZA:wght@100..400&display=swap');
    ...
    <section id="secMarmitas" class="card admin-card" style="display:none;">
      ...
      <form id="formMarmita">
        ...
        <div class="marmita-lists">
          <div>
            <label>Carboidratos (apenas 1 permitido)</label>
          ...
          <div>
            <label>Proteinas (ilimitadas)</label>
          ...
          <div>
            <label>Saladas (ilimitadas)</label>
          ...
          <div>
            <label>Adicionais (ilimitados)</label>
